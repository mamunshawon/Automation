...
data = read_excel("BookEMIFEE.xlsx")
...
for index, row in data.iterrows():
    driver.get(
        'https://sys.mynagad.com:20020/ui/system/#/fee-commission-management/detail/biller-merchant/FC0AG0BP014URYU021165')
    time.sleep(3)
    ...
    submit_button = driver.find_element(by=By.XPATH, value="/html/body/app-root/app-full-layout/div/div["
                                                           "2]/div/div/div/app-biller-merchant-fee-commission-create"
